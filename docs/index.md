...
- [Breaking changes in #36](../README.md#login-csrf-protection--the-oauth_state-cookie) -- **two** breaks: the cookie-jar requirement, and the changed shapes of `getAuthorizationUrl`, `handleCallback` and `pendingStates`
